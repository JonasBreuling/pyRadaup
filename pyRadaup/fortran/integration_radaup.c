...
void radaup_integration(double tini, double tend, double first_step,
                        ...
                        // func_report_radaup reportfun, // helper to report step status (failures, rejection...)
                        ...
                        )
{
  ...
  radaup(&n, fcn, &t, y, &tend, &dt,
         &rtol, &atol, &itol,
         jac_radaup, &ijac, &mljac, &mujac,
